...
public class bulkItems extends AppCompatActivity {
    ...
    String[] names = {"Fish (bulk)", "Shrimp (bulk)", "Spaghetti (bulk)", "French Fries (bulk)", "Applesauce (bulk)", "Coleslaw (bulk)"};
    int[] prices = {20, 20, 3, 3, 3, 4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bulk_items);
